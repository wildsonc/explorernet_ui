              ...
              <>
                <Text mt={10}>
                  ...
                  <strong>
                    R${" "}
                    {(
                      (usedDays * data.custumer.access_plan_price) /
                      30
                    ).toFixed(2)}
                  </strong>
                </Text>
                ...
                <Group mt={10} position="apart">
                  <Group>
                    ...
                    <Text>
                      {dateDiff(nextDate)}{" "}
                      {dateDiff(nextDate) > 1 ? "dias" : "dia"}
                    </Text>
                    <strong>
                      R${" "}
                      {(
                        (dateDiff(nextDate) * data.custumer.access_plan_price) /
                        30
                      ).toFixed(2)}
                    </strong>
                    <Switch
                ...
                <Group mt={3} position="center" align="start">
                  ...
                  <Group direction="column" position="center">
                    ...
                    <Text mt={-20} color="dimmed" weight={500}>
                      Entrada {((interest + totalPrice) * 0.4).toFixed(2)}
                    </Text>
                    <Text mt={-20} color="dimmed" weight={500}>
                      2x {(((interest + totalPrice) * 0.6) / 2).toFixed(2)}
                    </Text>
                  </Group>
                </Group>
              </>
