    ...
    <>
        ...
        >
          <Group position="center" direction="column">
            ...
            <Text color="dimmed" size="xs">
              Empresa apenas para seleção do template, a origem do envio é
              definida dinâmicamente.
            </Text>
          </Group>
        </Stepper.Step>
        <Stepper.Step
              ...
              <>
                <Box sx={{ width: 400 }}>
                  <Group mt={5} noWrap>
                    ...
                    <Text weight={500} color="blue" lineClamp={1} ml={-10}>
                      {file.name}
                    </Text>
                  </Group>
                  {template && (
                ...
                <Box ml={20}>
                  <ScrollArea sx={{ width: 800 }} type="always">
                  ...
                  {(status) => (
                    <div style={{ pointerEvents: "none" }}>
                      ...
                      <Text color="dimmed" align="center">
                        Arquivo <i>.csv</i> ou <i>.xlsx</i> de no máximo 5mb
                      </Text>
                    </div>
                  )}
                </Dropzone>
      ...
      <Group position="center" mt="xl">
        ...
        {active == 0 ? (
          ...
          <Button onClick={nextStep} disabled={templateSelected == undefined}>
            Próximo
          </Button>
        ) : active == 2 && file ? (
          <>
      ...
      >
        ...
        <Group position="center" mt={20}>
          <Button leftIcon={<Send size={18} />} onClick={() => test()}>
            Enviar
          </Button>
        </Group>
      </Modal>
